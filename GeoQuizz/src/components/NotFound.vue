<template>
    <div>
        <div id="box"></div>
        <h3 class="text-white text-center">Page introuvable</h3>
        <div class="text-center mt-4">
            <b-button variant="outline-dark"><router-link class="text-white text-decoration-none" :to="{ name: 'Connexion' }">Retour à la page de connexion</router-link></b-button>
        </div> 
    </div>
</template>
